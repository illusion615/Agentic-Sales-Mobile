...
2. 用户的消息可能引用上下文中的实体（代词、省略、缩写），根据对话历史和页面上下文综合理解
...
2. The user's message may reference entities from context (pronouns, omissions, abbreviations) — resolve them using conversation history and page context
