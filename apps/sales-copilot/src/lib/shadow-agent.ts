...
- For queryActivities: always set date filters. "today" → dateRange="today" OR scheduledDate=YYYY-MM-DD. "this week" → dateRange="7days" OR dateFrom/dateTo. "completed today" → dateRange="today" + status="completed". "pending"/"待办" → status="open" (NEVER draft/confirmed).
