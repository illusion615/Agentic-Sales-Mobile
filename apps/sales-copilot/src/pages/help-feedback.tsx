  ...
  },
  {
    ...
    skills: [
      ...
      },
      {
        ...
        nameZh: '智能客户匹配',
        description: 'Fuzzy match account names to find possible duplicates or confirm identity.',
        descriptionZh: '模糊匹配客户名称以查找可能的重复或确认身份。',
        voiceExamples: ['Is there an account like "Royal London"?'],
        voiceExamplesZh: ['有没有类似"Royal London"的客户？'],
      },
    ],
  },
  {
    ...
    skills: [
      ...
      },
      {
        ...
        voiceExamples: ['Find the ICU monitoring project'],
        voiceExamplesZh: ['查找ICU监护项目'],
      },
    ],
  },
  {
    ...
    skills: [
      ...
      },
      {
        ...
        nameZh: '智能活动匹配',
        description: 'Detect potential duplicate activities by matching title/description.',
        descriptionZh: '通过匹配标题/描述检测可能重复的活动。',
  ...
  },
  {
    ...
    skills: [
      ...
      },
      {
        ...
        nameZh: '智能联系人匹配',
        description: 'Fuzzy match contact names to find existing contacts or detect duplicates.',
        descriptionZh: '模糊匹配联系人姓名以查找现有联系人或检测重复。',
        voiceExamples: ['Find Dr. Smith'],
        voiceExamplesZh: ['查找Smith医生'],
      },
    ],
  },
  {
