 ...
 * surface can lift its content above the keyboard.
 *
 * ── Why this is needed ────────────────────────────────────────────────────
 ...
 *
 * When a Chromium host honours `interactive-widget=resizes-content` in the
 * viewport meta, the layout viewport already shrinks, so `innerHeight` tracks
 * `visualViewport.height` and this inset naturally resolves to ~0 — no double
 * shift. The two mechanisms are complementary, not redundant.
 *
